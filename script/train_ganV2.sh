python3 ./train/train_ganV2.py --arch Uformer_B --batch_size 3 --gpu '0' \
    --train_ps 128 --train_dir txt/train.txt --env _0711 \
    --val_dir txt/test.txt --save_dir ./logs/ \
    --dataset car --warmup --pretrain_weights logs/denoising/car/Uformer_B_0711/models/model_best.pth --resume
